    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <form method="post" action="">
                ...
                <table style="width:100%" class="table">
                    ...
                    <?php foreach($articles->result() as $row){
                        ...
                        <tr>
                            ...
                            <td><a href="/Examen/Flowerpower/editartikel/<?php echo $row->ID ?>">Wijzigen</a></td>
                            <td><a href="/Examen/Flowerpower/verwijderartikel/<?php echo $row->ID ?>">Verwijderen</a></td>
                        </tr>
                ...
                <input type="submit" value="Artikel toevoegen" name="toevoegen" class="btn btn-info">
