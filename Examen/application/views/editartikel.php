...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <br>
                <br>
                <?php foreach($currentarticle->result() as $row){ ?>
                <p>Artikelnaam</p>
                <input type="text" name="artikelnaam" value="<?php echo $row->Artikelnaam; ?>">
                <br>
                <p>Prijs</p>
                <input type="text" name="prijs" value="<?php echo $row->Prijs; } ?>">
