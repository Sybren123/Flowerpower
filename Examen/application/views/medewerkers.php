    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <?php foreach($data->result() as $row){ ?>
                    ...
                    <tr>
                       ...
                       <?php $convertdate = date('d-m-Y', strtotime($row->Geboortedatum)) ?>
                        ...
                        <td><a href="/Examen/Flowerpower/editmedewerker/<?php echo $row->ID ?>">Wijzigen</a></td>
                        <td><a href="/Examen/Flowerpower/verwijdermedewerker/<?php echo $row->ID ?>">Verwijderen</a></td>
            ...
            <form method="post" action="">
                <input type="submit" value="Toevoegen" name='add' class="btn btn-info">
            </form>
